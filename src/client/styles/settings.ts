/** Univer Office bundle configuration section aligned with the Plugins page. */
export const settingsStyles = `
.uvf_settingsCard{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;background:var(--dsw-alias-bg-layer-3);padding:14px 16px}
.uvf_settingsHead{display:flex;flex-direction:column;gap:4px}
...
.uvf_settingsBody{border-top:1px solid var(--dsw-alias-border-l2)}
...
@media (prefers-reduced-motion:reduce){.uvf_settingsSwitchThumb{transition:none}}
`
